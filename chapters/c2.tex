...
\section{本章总结}
本章研究了SDN IP网络下的并行业务量工程算法，首先提出了新的业务量工程效用函数，建立了业务量工程模型，设计了两种基于GPU的并行优化算法方案GA-PTEA和LR-PTEA，发现GA-PTEA的加速比可达20倍，LR-PTEA的加速比能达到6倍，LR-PTEA能够在短时间内得到目标函数的优化解。
